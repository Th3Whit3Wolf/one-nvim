...
local highlight_groups = {
    ...
    -------------------------------------------------------------
     ...
     Directory    = { fg = hue_2 },
     ErrorMsg     = { fg = hue_5, bg = mono_3 },
     VertSplit    = { fg = vertsplit },
     Folded       = { fg = mono_3, bg = mono_3 },
     ...
     PMenuSbar    = { fg = none, bg = mono_3 },
     PMenuThumb   = { fg = none, bg = mono_1 },
     Question     = { fg = hue_2 },
     Search       = { fg = mono_3, bg = hue_6_2 },
...
-----------------------------
     ...
     TSNamespace          = { fg = pink},
     TSNumber             = { fg = hue_6 },
     TSOperator           = { fg = mono_1 },
     TSParameter          = { fg = hue_1 },
     TSParameterReference = { fg = hue_1 },
     TSProperty           = { fg = hue_6_2 },
     TSPunctBracket       = { fg = mono_1 },
     TSPunctDelimiter     = { fg = mono_1 },
     TSPunctSpecial       = { fg = mono_1 },
     TSRepeat             = { fg = pink},
     TSString             = { fg = hue_4 },
     TSStringEscape       = { fg = hue_1 },
